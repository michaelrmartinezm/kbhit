...
{
    public class SqlLogDALC:LogDALC
    {
        public override int InsertarLogBE(LogBE obj)
        {
            ...
            try
            {
                ...
                sqlLogBEInsertar = "uspLogInsertar";
        ...
        public override List<LogBE> ListarLogBE()
        {
            SqlDataReader dr;
            SqlConnection Conn = null;
            SqlCommand cmd = null;
        ...
        public override List<LogBE> ListarLogBETabla(String Tabla)
        {
            SqlDataReader dr;
            SqlConnection Conn = null;
            SqlCommand cmd = null;
        ...
        public override List<LogBE> ListarLogBEUsuario(String Usuario)
        {
            SqlDataReader dr;
            SqlConnection Conn = null;
            SqlCommand cmd = null;
        ...
        public override List<LogBE> ListarLogBEFecha(DateTime Fecha)
        {
            SqlDataReader dr;
            SqlConnection Conn = null;
            SqlCommand cmd = null;
        ...
        public override List<LogBE> ListarLogBEIP(String IP)
        {
            SqlDataReader dr;
            SqlConnection Conn = null;
            SqlCommand cmd = null;
