...
namespace UPC.Trabajo.KBHit
{
    internal partial class frmNotificacion : Form
    {
        ...
        private void frmNotificacion_Load(object sender, EventArgs e)
        {
            ...
            Location = new Point(Screen.PrimaryScreen.Bounds.Right - Size.Width - 10, Screen.PrimaryScreen.Bounds.Bottom);
        ...
        {
            posicion += 5;
            Location = new Point(Screen.PrimaryScreen.Bounds.Right - posicion - 37, posVertical);
            ...
            if (posicion >= 190)
            {
                ...
                using (SoundPlayer myPlayer = new SoundPlayer(UPC.Trabajo.KBHit.External.recursos.Popup))
                {
                    myPlayer.Play();
                }
            }
        ...
        {
            posicion -= 5;
            Location = new Point(Screen.PrimaryScreen.Bounds.Right - posicion, posVertical);
