...
{
    public partial class frmPlandeVuelo : Telerik.WinControls.UI.ShapedForm
    {
        ...
        private void InGuardarPlanDeVuelo(object sender, EventArgs e)
        {
            try
            {
                ...
                String msg = String.Format("He seleccionado la aerolinea: {0} cuyo código es: {1}", cbAerolinea.SelectedText, cbAerolinea.SelectedValue);
        ...
        {
            int valueI;
            long valueL = Convert.ToInt64(txtNumero.Text);
            float valueF;
            if (valueL > 0)
            {
        ...
        private static int StateChecked(CheckBox obj)
        {
